...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.eeg_channel_combo_box_3 = QtGui.QComboBox(self.groupBox_3)
        self.eeg_channel_combo_box_3.setObjectName(_fromUtf8("eeg_channel_combo_box_3"))
        self.gridLayout_7.addWidget(self.eeg_channel_combo_box_3, 1, 2, 1, 1)
        self.epoch_tmin_spinbox_2 = QtGui.QDoubleSpinBox(self.groupBox_3)
        self.epoch_tmin_spinbox_2.setMinimum(-1.0)
        self.epoch_tmin_spinbox_2.setMaximum(1.0)
        self.epoch_tmin_spinbox_2.setSingleStep(0.01)
        self.epoch_tmin_spinbox_2.setProperty("value", -0.2)
        self.epoch_tmin_spinbox_2.setObjectName(_fromUtf8("epoch_tmin_spinbox_2"))
        self.gridLayout_7.addWidget(self.epoch_tmin_spinbox_2, 2, 2, 1, 1)
        self.label_7 = QtGui.QLabel(self.groupBox_3)
        self.label_7.setObjectName(_fromUtf8("label_7"))
        self.gridLayout_7.addWidget(self.label_7, 3, 0, 1, 1)
        self.epoch_tmax_spinbox_2 = QtGui.QDoubleSpinBox(self.groupBox_3)
        self.epoch_tmax_spinbox_2.setMinimum(-1.0)
        self.epoch_tmax_spinbox_2.setMaximum(5.0)
        self.epoch_tmax_spinbox_2.setSingleStep(0.01)
        self.epoch_tmax_spinbox_2.setProperty("value", 0.5)
        self.epoch_tmax_spinbox_2.setObjectName(_fromUtf8("epoch_tmax_spinbox_2"))
        self.gridLayout_7.addWidget(self.epoch_tmax_spinbox_2, 3, 2, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_2.setText(_translate("MainWindow", "Create Epochs", None))
